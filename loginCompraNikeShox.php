...
$products = [
  5 => ['id' => 5, 'name' => 'Nike Shox TL - Black and Max Orange', 'price' => 1299.90, 'quantity' => 1],
];
...
<header>
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/nikeShox.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/nikeShox2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/nikeShox3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                <h2>
                    Nike Shox TL - Black and Max Orange
                </h2>
                <p id="hahaha">
                    Como se você precisasse de outro motivo para usar preto. Esta versão do ícone do início da década de
                    2000 vem enfeitada no tom causador de efeito que você ama. Tornado famoso por seu amortecimento
                    mecânico e destreza nas quadras, o design de virar a cabeça também tem muito apelo nas passarelas.
                </p>
                <hr>
                <h1>R$ 1.299,90 </h1>
                <section class="hehehe">
                    <h2>Tamanhos</h2>
                    <button id="pau" type="submit">36</button>
                    <button style="margin-left:52%;" id="pau" type="submit">37</button>
                    <button style="margin-left:58%;" id="pau" type="submit">38</button>
                    <button style="margin-left:64%;" id="pau" type="submit">39</button>
                    <button style="margin-left:70%;" id="pau" type="submit">40</button>
                </section>
                ...
                <a href="?id=5"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
