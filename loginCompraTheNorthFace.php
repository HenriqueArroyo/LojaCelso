...
$products = [
  9 => ['id' => 9, 'name' => 'Fleece Tka 100 Glacier 1/4 Zíper Feminino Branco', 'price' => 299.90, 'quantity' => 1],
];
...
<header>
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/TNFF1.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/TNFF2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/TNFF3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                <h2>
                    Fleece Tka 100 Glacier 1/4 Zíper Feminino Branco
                </h2>
                <p id="hahaha">
                    O Fleece Tka 100 Glacier 1/4 Ziper Feminino é perfeito para quem busca aquecimento com leveza e
                    muita praticidade. Altamente respirável e eficiente, ele pode ser usado nas mais diversas atividades
                    físicas.
                </p>
                <hr>
                <h1>R$ 299,90 </h1>
                ...
                <a href="?id=9"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
