...
$products = [
  4 => ['id' => 4, 'name' => 'Nike Nocta', 'price' => 329,90, 'quantity' => 1],
];
    ...
    <section>
        <div class="box">
            ...
            <div class="pinto">
                ...
                <a href="?id=4"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
