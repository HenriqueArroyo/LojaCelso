...
$products = [
  8 => ['id' => 8, 'name' => 'Tech Fleece Pant', 'price' => 299.90, 'quantity' => 1],
];
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/calcaTech.png" width="100000px" height="750px" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/calcaTech2.png" width="100000px" height="750px" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/calcaTech3.png" width="100000px" height="750px" class="d-block w-100" alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                ...
                <p id="hahaha">
                    Nossa calça NOCTA Tech Fleece Open-Hem é uma peça de assinatura destinada a ser combinada com nossa
                    NOCTA Tech Fleece Crew e NOCTA Tech Fleece Hoodie. Com cordões tecnológicos premium, bolsos laterais
                    NOCTA, bolsos tecnológicos NOCTA, logotipos NOCTA HD, bainha aberta articulada.
                </p>
                <hr>
                <h1>R$ 299,90 </h1>
                ...
                <a href="?id=8"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
