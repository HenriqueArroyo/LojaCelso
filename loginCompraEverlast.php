...
$products = [
  2 => ['id' => 2, 'name' => 'Everlast + RVCA Mister Cartoon MIM GlovesNike X Nocta', 'price' => 1099.90, 'quantity' => 1],
];
...
<header>
    <nav class="navbar navbar-expand-lg bg-black">
        ...
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/glovesEverlast1.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/glovesEverlast2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/glovesEverlast3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                <h2>
                    Everlast + RVCA Mister Cartoon MIM GlovesNike X Nocta
                </h2>
                <p id="hahaha">
                    Com tradições que superam os padrões, chegou a joia da coroa Everlast x RVCA x Mister Cartoon. As
                    luvas de boxe Everlast MX2 Pro Laced de edição limitada feitas à mão no México.
                </p>
                <hr>
                <h1>R$ 1.099,90 </h1>
                <section class="hehehe">
                    <h2>Tamanhos</h2>
                    <button id="pau" type="submit">Único</button>
                </section>
                ...
                <a href="?id=2"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
