...
$products = [
  7 => ['id' => 7, 'name' => 'Shorts Evostripe malha Ddupla masculina', 'price' => 249.90, 'quantity' => 1],
];
...
<header>
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/pumaS.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/pumaS2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/pumaS3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                <h2>
                    Shorts Evostripe malha Ddupla masculina
                </h2>
                <p id="hahaha">
                    As linhas de corte EVOSTRIPE e o tecido tecnológico de ponta se combinam para criar esta peça que
                    permite a máxima liberdade de movimento.
                </p>
                <hr>
                <h1>R$ 249,90 </h1>
                ...
                <a href="?id=7"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
