...
$products = [
  3 => ['id' => 3, 'name' => 'Mochila Oakley KITCHEN SINK', 'price' => 699.90, 'quantity' => 1],
];
...
<header>
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/oakley.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">  
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/MochilaOakley2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/MochilaOakley3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                <h2>
                    Mochila Oakley KITCHEN SINK
                </h2>
                <p id="hahaha">
                    A Mochila Oakley KITCHEN SINK é sem dúvidas a mochila mais emblemática da Oakley. Com design
                    disruptivo e inovador, esta mochila possui compartimento acolchoado com duplo acesso ao seu laptop
                    de até 17 polegadas.
                </p>
                <hr>
                <h1>R$ 699,90 </h1>
                ...
                <a href="?id=3"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
