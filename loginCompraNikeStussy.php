...
$products = [
  6 => ['id' => 6, 'name' => 'Nike X Stussy', 'price' => 1499.90, 'quantity' => 1],
];
    ...
    <section>
        <div class="box">
            <div style="height: 750px; width: 700px;" id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/Images/nikeStussy1.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/nikeStussy2.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/Images/nikeStussy3.png" width="100000px" height="750px" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
            ...
            <div class="pinto">
                ...
                <p id="hahaha">
                    Todo look precisa de uma camiseta. Melhore o seu jogo com esta nova versão do básico do seu
                    guarda-roupa. Seu ajuste relaxado, algodão macio e estampas ousadas combinam conforto com estilo.
                </p>
                <hr>
                <h1>R$ 1.499,90 </h1>
                <section class="hehehe">
                    <h2>Tamanhos</h2>
                    <button id="pau" type="submit">37</button>
                    <button style="margin-left:52%;" id="pau" type="submit">38</button>
                    <button style="margin-left:58%;" id="pau" type="submit">39</button>
                    <button style="margin-left:64%;" id="pau" type="submit">40</button>
                    <button style="margin-left:70%;" id="pau" type="submit">41</button>
                </section>
                ...
                <a href="?id=6"><button value="Adicionar ao Carrinho" type="submit" style="height:50px; color: white; background-color: black; margin-left: 46%; margin-top: 1%; width: 50%;">Adicionar ao Carrinho</button></a>
            </div>
        </div>
    </section>
